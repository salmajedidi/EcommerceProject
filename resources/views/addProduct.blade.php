...
<body>
    ...
    <section class="product spad">
        <div class="container">
            <div class="row">
                ...
                <img src="img/shopping-cart-home.jpg" class="breadcrumb-section set-bg" alt="Responsive image">
                </div>
    ...
    @endif
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="exampleInputQuantity">Price</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="description" id="description" aria-describedby="emailHelp" placeholder="Enter description">
                                <small id="emailHelp" class="form-text text-muted"></small>
                            </div>
                            <div class="form-group">
